...
public class DispatchServlet extends HttpServlet {
    ...
    private final String STARTUP_ACCOUNT_CONTROLLER = "StartupAccountServerlet";
    private final String ADD_ITEMS_TO_YOUR_CART = "AddItemToCartServlet";
    private final String VIEW_ITEM_CART_PAGE = "viewCart.jsp";
    private final String REMOVE_ITEM_FROM_CART = "RemoveItemFromcart";
    private final String CHECK_OUT_ITEMS = "CheckOutServlet";
...
//        HashMap<String, String> roadmap = (HashMap<String, String>) request.getServletContext().getAttribute("ROADMAP");
        //which button did User licked?
        String button = request.getParameter("btAction");
        String url = null;
        try {
            if (button == null) {
                url = STARTUP_ACCOUNT_CONTROLLER;
                ...
                url = ADD_ITEMS_TO_YOUR_CART;
            } else if (button.equals("ShowCart")) {
                url = VIEW_ITEM_CART_PAGE;
